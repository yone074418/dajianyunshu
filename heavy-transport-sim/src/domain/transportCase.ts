...
export const UNIQUE_TRANSPORT_CASE: TransportCase = {
  ...
  origin: {
    name: '东港重型装备制造厂',
    type: '制造厂',
    description: '位于东港工业园区的大型变压器制造基地。',
  },
  destination: {
    name: '西郊 500kV 变电站施工现场',
    type: '变电站施工现场',
    description: '位于城市西郊的 500kV 变电站建设工地。',
  },
  cargo: {
    id: 'cargo-large-transformer-001',
    name: '500kV 大型电力变压器',
    category: '电力变压器',
    dimensions: { lengthM: 8.8, widthM: 3.4, heightM: 4.2 },
    weightT: 168,
    unit: '米/吨',
    ...
    isOverweight: true,
    centerOfGravity: { xM: 4.4, yM: 2.1, zM: 1.7 },
    description: '500kV 大型电力变压器，不可拆解整体运输。',
  },
  objectives: [
    '根据货物尺寸和重量选择合适的运输车辆',
    '分析起点到终点的可选运输路线',
  ...
  constraints: {
    ...
    turning: '弯道半径必须满足车辆转弯要求',
    slope: '坡度不得超过车辆爬坡能力限制',
    bridge: '沿线桥梁承载能力必须大于车货总重',
    axleLoad: '各轴轴载不得超过道路承载标准',
    lashing: '绑扎方案必须满足大件运输固定要求',
  },
  teachingNotes: [
...
export function getUniqueTransportCase(): TransportCase {
  return UNIQUE_TRANSPORT_CASE
}
